<template>
  <nav class="wood-bg sticky top-0 z-40 backdrop-blur border-b border-gray-200 dark:border-gray-800">
...
.wood-bg {
  ...
  background-image:
    repeating-linear-gradient(90deg, rgba(169,113,66,0.06) 0px, rgba(169,113,66,0.06) 2px, transparent 2px, transparent 6px),
    linear-gradient(0deg, rgba(169,113,66,0.05), rgba(169,113,66,0.02) 60%, rgba(169,113,66,0.05)),
...
.dark .wood-bg {
  ...
  background-image:
    repeating-linear-gradient(90deg, rgba(193,135,90,0.10) 0px, rgba(193,135,90,0.10) 2px, transparent 2px, transparent 6px),
    linear-gradient(0deg, rgba(161,113,77,0.12), rgba(161,113,77,0.06) 60%, rgba(161,113,77,0.12)),
