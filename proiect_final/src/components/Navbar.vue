...
<template>
  <nav
    class="wood-bg-navbar sticky top-0 z-40 bg-white/80 dark:bg-transparent backdrop-blur border-b border-gray-200 dark:border-gray-800"
  >
        ...
        <div class="flex items-center gap-2 sm:gap-4">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
              ...
              <path
                d="M7 18a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm10 0a2 2 0 1 0 .001 4A2 2 0 0 0 17 18ZM3 4h2l2.4 9.6A3 3 0 0 0 10.3 16H18a3 3 0 0 0 2.9-2.2l1.6-6A1 1 0 0 0 21.6 6H6.2l-.5-2H3Z"/>
            </svg>
